        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 sm:p-6 lg:p-8 flex flex-col items-center justify-start relative">
            ...
            <div class="w-full max-w-xl mt-2 sm:mt-4">
                ...
                <div class="text-center mb-6 sm:mb-8">
                    <div class="w-16 h-16 sm:w-20 sm:h-20 bg-amber-50 text-amber-500 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 text-3xl sm:text-4xl shadow-inner">
                        <i class="fa-solid fa-store"></i>
                    </div>
                    <h2 class="text-2xl sm:text-3xl font-bold text-slate-800 tracking-tight">Validasi Produk Titipan</h2>
                    <p class="text-sm text-secondary mt-2 max-w-sm mx-auto">Scan struk barcode atau ketik Nomor Invoice untuk menerima barang titipan UMKM.</p>
                </div>
                    ...
                    <form id="formScan" class="flex flex-col sm:flex-row gap-3">
                        <div class="relative flex-1">
                            <input type="text" id="barcodeInput" name="barcode" autocomplete="off" 
                                class="w-full text-center sm:text-left text-lg font-mono tracking-wider px-5 py-4 border-2 border-slate-200 rounded-2xl focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 outline-none transition-all placeholder:text-slate-300 placeholder:tracking-normal uppercase bg-slate-50 focus:bg-white" 
                                placeholder="Cth: TTP-260423-001" required>
                        </div>
                        <button type="submit" class="w-full sm:w-auto bg-amber-500 hover:bg-amber-600 text-white px-8 py-4 rounded-2xl font-bold transition-all shadow-md flex items-center justify-center gap-2 shrink-0">
        ...
        <div class="relative bg-surface w-full max-w-md rounded-3xl shadow-2xl z-[110] transform transition-all flex flex-col overflow-hidden max-h-[90vh]">
            ...
            <div class="p-6 sm:p-8 flex flex-col h-full">
                <div class="text-center mb-5 border-b border-slate-100 pb-5">
                    <div class="w-14 h-14 bg-amber-50 text-amber-500 rounded-full flex items-center justify-center mx-auto mb-3 text-2xl">
                        <i class="fa-solid fa-box-open"></i>
                    </div>
                    <h3 class="text-xl font-black text-slate-800 mb-1">Cek Fisik Barang Titipan!</h3>
                    <p class="text-xs text-secondary leading-relaxed px-4">Pastikan jumlah fisik produk titipan di keranjang benar-benar sesuai dengan daftar di bawah ini.</p>
                </div>
                ...
                <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4 text-left mb-6 flex flex-col overflow-hidden">
                    <div class="flex justify-between items-center mb-3 pb-3 border-b border-slate-200">
                        ...
                        <div class="font-mono font-black text-amber-600 text-base bg-amber-50 px-3 py-1 rounded-lg" id="konf-invoice">INV-XXXX</div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-3 text-xs pt-3 border-t border-slate-200">
                        <div class="bg-white p-2 rounded-lg border border-slate-100">
                            <span class="text-slate-400 block mb-0.5 font-semibold text-[10px] uppercase">Pengirim:</span>
                ...
                <div class="flex flex-col gap-3 mt-auto shrink-0">
                    <button onclick="prosesValidasi('received')" class="w-full bg-emerald-500 hover:bg-emerald-600 text-white py-3.5 rounded-xl text-sm font-bold transition-all shadow-md flex items-center justify-center gap-2">
