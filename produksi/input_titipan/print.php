...
$stmtDetail = $pdo->prepare("
    SELECT b.nama_barang as produk, b.nama_umkm, d.quantity, d.barcode
...
$total_keseluruhan = 0;
foreach ($details as $d) { $total_keseluruhan += (int)$d['quantity']; }
?>
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
    <title>Struk Titipan UMKM</title>
    <script src="https://cdn.jsdelivr.net/npm/jsbarcode@3.11.5/dist/JsBarcode.all.min.js"></script>
    <style>
        @page { margin: 0; }
        body { font-family: 'Courier New', Courier, monospace; width: 80mm; margin: 0 auto; padding: 5mm; font-size: 14px; line-height: 1.3; }
...
<body>
    ...
    <div class="text-center">
        <div class="title">PRODUK TITIPAN UMKM</div>
    ...
    <table class="table-produk">
        ...
        <tr>
            ...
            <td>
                <?= strtoupper($d['produk']) ?><br>
                <span style="font-size: 11px;">[<?= $d['nama_umkm'] ?>]</span>
            </td>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            JsBarcode("#barcode", "<?= $barcode_str ?>", {
                format: "CODE128", displayValue: true, fontSize: 18, height: 70, width: 1.8, textMargin: 6, margin: 5             
            });
