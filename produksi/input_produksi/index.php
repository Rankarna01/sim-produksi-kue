                    ...
                    <form id="formProduksi" class="p-5 sm:p-8 md:p-10">
                        <div class="space-y-6">
                            ...
                            <div class="bg-indigo-50 p-4 sm:p-6 rounded-2xl border border-indigo-100">
                                ...
                                <select id="employee_id" name="employee_id" required class="w-full px-4 py-3 sm:py-4 border-2 border-indigo-200 rounded-xl focus:ring-0 focus:border-indigo-600 outline-none transition-all bg-white text-base font-bold text-indigo-900 cursor-pointer shadow-sm">
