...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            /* Membantu pengelompokan baris agar tidak terpotong di tengah kertas */
    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 sm:p-6 lg:p-8 w-full">
            ...
            <div id="print-header" class="hidden">
                <h1 style="font-size: 24px; font-weight: bold; margin-bottom: 5px;">LAPORAN RESEP (BILL OF MATERIAL)</h1>
            ...
            <div id="form-filter-section" class="bg-surface p-5 rounded-2xl shadow-sm border border-slate-200 mb-6">
                <form id="formFilter" class="flex flex-col md:flex-row gap-4 items-end">
                    ...
                    <div class="flex-1 w-full">
                        <label class="block text-xs font-bold text-slate-500 mb-1 uppercase tracking-wider">Cari Nama Produk / Bahan Baku</label>
                        <input type="text" id="search" name="search" placeholder="Cari kue atau bahan (Misal: Coklat)..." class="w-full px-4 py-2 border border-slate-300 rounded-xl focus:border-primary outline-none text-sm">
                    </div>
                    ...
                    <table class="w-full text-left border-collapse min-w-[700px]">
                        <thead>
                            <tr class="bg-slate-50 border-b border-slate-200 text-xs text-secondary uppercase tracking-wider print:bg-slate-100">
                                ...
                                <th class="p-4 font-bold">Bahan Baku (Komposisi)</th>
                                <th class="p-4 font-bold text-right">Takaran Per 1 Pcs</th>
