    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 sm:p-6 lg:p-8 w-full">
            ...
            <div id="print-header" class="hidden">
                <h1 style="font-size: 24px; font-weight: bold; margin-bottom: 5px;">LAPORAN STOK BAHAN BAKU</h1>
            ...
            <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 no-print">
                <div>
                    ...
                    <p class="text-sm text-secondary mt-1">Pantau sisa stok bahan baku Anda secara real-time.</p>
                </div>
            ...
            <div id="form-filter-section" class="bg-surface p-5 rounded-2xl shadow-sm border border-slate-200 mb-6">
                <form id="formFilter" class="flex flex-col md:flex-row gap-4 items-end">
                    ...
                    <div class="flex-1 w-full">
                        ...
                        <input type="text" id="search" name="search" placeholder="Misal: Tepung..." class="w-full px-4 py-2 border border-slate-300 rounded-xl focus:border-primary outline-none text-sm">
                    </div>
                    
                    <div class="flex-1 w-full">
                        <label class="block text-xs font-bold text-slate-500 mb-1 uppercase tracking-wider">Status Stok</label>
                        <select id="status_stok" name="status_stok" class="w-full px-4 py-2 border border-slate-300 rounded-xl focus:border-primary outline-none text-sm">
