                        ...
                        <table class="w-full text-left border-collapse min-w-[700px]">
                            <thead>
                                <tr class="bg-slate-50 border-b border-slate-200 text-sm text-secondary uppercase tracking-wider">
                                    ...
                                    <th class="p-4 font-semibold">Lokasi Akses</th>
            ...
            <div class="p-6">
                <form id="formUser" class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-1">Hak Akses <span class="text-danger">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-1">Lokasi Dapur <span class="text-xs text-slate-400 font-normal">(Opsional)</span></label>
                            <select id="user_kitchen_id" name="kitchen_id" class="w-full px-4 py-2.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary outline-none transition-all bg-slate-50 focus:bg-surface">
                    ...
                    <p class="text-[10px] text-primary bg-blue-50 p-2 rounded-lg mt-2">
                        *Jika peran adalah "Produksi", <strong>wajib</strong> memilih Lokasi Dapur agar input produksi tidak tertukar.
                    </p>
