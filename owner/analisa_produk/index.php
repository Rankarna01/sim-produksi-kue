    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 sm:p-6 lg:p-8 w-full">
            ...
            <div id="print-header" class="hidden">
                <h1 style="font-size: 24px; font-weight: bold; margin-bottom: 5px;">LAPORAN ANALISA KERUGIAN (LOSS RATE) PRODUK</h1>
            ...
            <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 no-print">
                <div>
                    <h2 class="text-2xl font-bold text-slate-800 tracking-tight">Analisa Performa & Kerugian</h2>
                    <p class="text-sm text-secondary mt-1">Pantau perbandingan jumlah produksi vs produk terbuang (Loss Rate) untuk evaluasi bisnis.</p>
                </div>
            ...
            <div id="form-filter-section" class="bg-surface p-5 rounded-2xl shadow-sm border border-slate-200 mb-6">
                <form id="formFilter" class="flex flex-col md:flex-row gap-4 items-end flex-wrap">
                    ...
                    <div class="w-full md:w-40">
                        ...
                        <select id="kitchen_id" name="kitchen_id" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:border-primary outline-none text-sm">
                    ...
                    <div class="w-full md:w-auto flex gap-2">
                        <button type="submit" class="flex-1 bg-amber-500 hover:bg-amber-600 text-white px-6 py-2 rounded-xl font-bold transition-all shadow-sm">
                            <i class="fa-solid fa-magnifying-glass-chart mr-1"></i> Analisa
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div id="summary-cards" class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div class="summary-card bg-surface rounded-2xl shadow-sm border border-slate-200 p-5 flex items-center gap-4 relative overflow-hidden">
                    ...
                    <div class="z-10">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-wider">Total Produksi Valid</p>
                        <h3 class="text-2xl font-black text-slate-800" id="sum-produksi">0 <span class="text-sm font-semibold text-slate-500">Pcs</span></h3>
                    </div>
                </div>
                <div class="summary-card bg-surface rounded-2xl shadow-sm border border-slate-200 p-5 flex items-center gap-4 relative overflow-hidden">
                    <div class="w-14 h-14 rounded-full bg-danger/10 text-danger flex items-center justify-center text-2xl z-10"><i class="fa-solid fa-trash-can"></i></div>
                    <div class="z-10">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-wider">Total Terbuang (Basi/Rusak)</p>
                        <h3 class="text-2xl font-black text-danger" id="sum-terbuang">0 <span class="text-sm font-semibold text-danger/70">Pcs</span></h3>
                    </div>
                </div>
                <div class="summary-card bg-surface rounded-2xl shadow-sm border border-slate-200 p-5 flex items-center gap-4 relative overflow-hidden">
                    <div class="w-14 h-14 rounded-full bg-amber-50 text-amber-500 flex items-center justify-center text-2xl z-10"><i class="fa-solid fa-chart-line-down"></i></div>
                    <div class="z-10">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-wider">Rata-Rata Kerugian (Loss Rate)</p>
                        <h3 class="text-2xl font-black text-amber-600" id="sum-persen">0%</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-surface rounded-2xl shadow-sm border border-slate-200 overflow-hidden print:shadow-none print:border-none">
                <div class="p-4 border-b border-slate-100 bg-slate-50 flex items-center gap-2">
                    <i class="fa-solid fa-ranking-star text-amber-500 text-lg"></i>
                    <h3 class="font-bold text-slate-700">Peringkat Produk Paling Sering Terbuang</h3>
                </div>
                    ...
                    <table class="w-full text-left border-collapse min-w-[800px]">
                        <thead>
                            <tr class="bg-slate-50 border-b border-slate-200 text-xs text-secondary uppercase tracking-wider print:bg-slate-100">
                                <th class="p-4 font-bold w-16 text-center">Peringkat</th>
                                <th class="p-4 font-bold">Nama Produk</th>
                                <th class="p-4 font-bold text-right">Diproduksi (Pcs)</th>
                                <th class="p-4 font-bold text-right text-danger">Dibuang (Pcs)</th>
                                <th class="p-4 font-bold text-center">Persentase Loss</th>
                                <th class="p-4 font-bold text-center">Status Performa</th>
                            </tr>
                        </thead>
                        <tbody id="table-analisa" class="text-sm divide-y divide-slate-100">
                            <tr><td colspan="6" class="p-8 text-center text-secondary">Memuat data analisa...</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
