...
<aside id="main-sidebar" class="w-64 bg-surface border-r border-slate-200 flex-col shadow-sm fixed inset-y-0 left-0 z-[70] transform -translate-x-full md:relative md:translate-x-0 transition-transform duration-300 flex">
    ...
    <nav class="flex-1 px-4 space-y-1 overflow-y-auto pb-6">
        ...
        <a href="/sim-produksi-kue/owner/master_satuan/" onclick="closeSidebarMobile()" class="flex items-center gap-3 px-4 py-2.5 rounded-xl transition-colors <?= getNavClass('/owner/master_satuan/', $current_uri) ?>">
        ...
        <div class="px-2 py-3 mt-4 border-t border-slate-100">
            ...
            <a href="/sim-produksi-kue/owner/laporan_keluar/" onclick="closeSidebarMobile()" class="flex items-center gap-3 px-4 py-2.5 rounded-xl transition-colors <?= getNavClass('/owner/laporan_keluar/', $current_uri) ?>">
                <i class="fa-solid fa-box-open w-5 text-center text-danger"></i> <span class="text-sm">Lap. Produk Keluar</span>
            </a>

            <a href="/sim-produksi-kue/owner/audit_logs/" onclick="closeSidebarMobile()" class="flex items-center gap-3 px-4 py-2.5 rounded-xl transition-colors <?= getNavClass('/owner/audit_logs/', $current_uri) ?>">
