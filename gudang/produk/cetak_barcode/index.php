...
<body class="text-slate-800 antialiased h-screen flex overflow-hidden bg-slate-50">
    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 sm:p-6 lg:p-8" x-data="{ tab: 'produk' }">
            <div class="mb-6">
            ...
            <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 md:p-8 mb-6">
                ...
                <div class="flex border-b border-slate-100 mb-6 gap-6">
                    <button @click="tab = 'produk'" :class="tab === 'produk' ? 'border-blue-600 text-blue-600' : 'border-transparent text-slate-400 hover:text-slate-600'" class="pb-3 text-sm font-black uppercase tracking-widest border-b-2 transition-all">
                        <i class="fa-solid fa-box mr-2"></i> Barcode Produk
                    </button>
                    <button @click="tab = 'rak'" :class="tab === 'rak' ? 'border-emerald-600 text-emerald-600' : 'border-transparent text-slate-400 hover:text-slate-600'" class="pb-3 text-sm font-black uppercase tracking-widest border-b-2 transition-all">
                        <i class="fa-solid fa-server mr-2"></i> Barcode Rak
                    </button>
                </div>
                ...
                <div x-show="tab === 'produk'" x-transition.opacity>
                    <div class="flex flex-col md:flex-row gap-4 items-end">
                        ...
                        <button onclick="addProduk()" class="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-xl font-black shadow-md shadow-blue-200 transition-all flex items-center justify-center gap-2">
                            <i class="fa-solid fa-arrow-down"></i> Simpan ke Preview
                        </button>
                    </div>
                </div>

                <!-- Konten Tab: RAK -->
                <div x-show="tab === 'rak'" x-transition.opacity style="display: none;">
                    <div class="flex flex-col md:flex-row gap-4 items-end">
                        <div class="flex-1 w-full relative">
            ...
            <!-- AREA PENGATURAN TAMPILAN BARCODE -->
            <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 md:p-8 mb-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <select id="set_format" onchange="updatePreview()" class="w-full px-4 py-2 border border-slate-300 rounded-lg font-bold text-sm bg-slate-50">
                            ...
                            <option value="CODE39">C39+ (Extended)</option>
                            <option value="CODE128">C93</option>
                            <option value="CODE128">C93E (Extended)</option>
                            <option value="EAN13">EAN13</option>
                            <option value="UPC">UPC</option>
                        </select>
                        <p class="text-[8px] text-slate-400 mt-1 italic">*Format fallback ke C128 jika browser tidak support</p>
                    </div>
                    <div>
                        ...
                        <select id="set_paper" onchange="toggleCustomLayout()" class="w-full px-4 py-2 border border-slate-300 rounded-lg font-bold text-sm bg-slate-50">
                            ...
                            <option value="tj107">Tom & Jerry 107</option>
                            <option value="tj108">Tom & Jerry 108</option>
                            <option value="custom">Custom Thermal</option>
                        </select>
                    </div>
                </div>
            ...
            <div id="custom_layout_panel" class="bg-white rounded-3xl border border-blue-200 shadow-sm p-6 md:p-8 mb-6" style="display: none;">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase mb-1">Tinggi Label (px)</label>
                        <input type="number" id="ly_h" value="150" class="w-full px-3 py-2 border rounded-lg text-sm font-bold bg-blue-50">
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase mb-1">Lebar Label (px)</label>
                ...
                <button onclick="updatePreview()" class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-xl text-xs font-black transition-all shadow-md">Terapkan Custom Layout</button>
            </div>
            ...
            <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col min-h-[500px]">
                ...
                <div class="flex-1 bg-slate-200 p-8 flex justify-center overflow-auto custom-scrollbar">
                    <div id="preview_paper" class="bg-white shadow-xl flex flex-wrap content-start transition-all rounded-lg p-2 gap-2" style="width: 100%;">
                        <div class="w-full text-center py-20 text-slate-400 font-bold italic opacity-60 flex flex-col items-center gap-3">
                            ...
                            <p>Area Preview. Klik "Simpan ke Preview" dari produk/rak untuk memunculkan barcode.</p>
                        </div>
                    </div>
                </div>
            </div>
