        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 sm:p-6 lg:p-8">
            ...
            <div class="mb-6 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                <div class="flex flex-wrap items-center gap-3">
                    <h2 class="text-2xl font-black text-slate-800 tracking-tight">Laporan Purchase Order</h2>
                    
                    <select id="filter_status_po" onchange="loadData()" class="px-3 py-2 border border-slate-300 rounded-lg outline-none text-xs font-bold text-slate-600 bg-white">
                    ...
                    <select id="filter_status_pay" onchange="loadData()" class="px-3 py-2 border border-slate-300 rounded-lg outline-none text-xs font-bold text-slate-600 bg-white">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    <div class="relative">
                        ...
                        <input type="text" id="search" placeholder="Cari dalam laporan..." onkeyup="cariData()" class="pl-8 pr-3 py-2 border border-slate-300 rounded-lg outline-none text-sm w-48 focus:border-blue-600 shadow-sm">
                    </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm">
                        <thead class="bg-slate-50 border-b border-slate-100">
                            <tr class="text-xs font-black text-slate-600 whitespace-nowrap">
                                <th class="p-4">ID PO</th>
                                <th class="p-4">Waktu Buat</th>
                                <th class="p-4">Waktu Terima</th>
