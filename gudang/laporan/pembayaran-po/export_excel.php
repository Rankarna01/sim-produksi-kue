...
<table border="1">
    <thead>
        <tr><th colspan="7"><h3>LAPORAN PEMBAYARAN PO (HUTANG SUPPLIER)</h3></th></tr>
        <tr><th colspan="7">Waktu Tarik: <?= date('d M Y H:i:s') ?></th></tr>
        <tr>
    ...
    <tbody>
        ...
        <?php endforeach; ?>
        <tr>
            <td colspan="6" style="text-align: right; font-weight: bold; background-color: #f4f4f4;">TOTAL PEMBAYARAN</td>
