        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 sm:p-6 lg:p-8">
            ...
            <div class="mb-6 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                <div class="flex items-center gap-4">
                    <h2 class="text-2xl font-black text-slate-800 tracking-tight">Laporan Stok Terbanyak</h2>
                    
                    <select id="filter_status" onchange="loadData()" class="px-3 py-2 border border-slate-300 rounded-lg outline-none text-xs font-bold text-slate-600 bg-white">
                        <option value="active">Non-Arsip (Aktif)</option>
                        <option value="inactive">Arsip (Non-Aktif)</option>
